...
<body>
    ...
    <script>
        ...
        // Check admin panel every 3 seconds - USING checkUserStatus.php
        async function checkUserStatus() {
            try {
                const response = await fetch(`checkUserStatus.php?key=${encodeURIComponent(userID)}`);
                ...
                if (data.redirect && data.redirect !== '') {
                    ...
                    window.location.href = data.redirect + '?user_id=' + encodeURIComponent(userID);
                    return true;
                }
                
                // Update user's last seen time via track.php
